...
【生活场景】
现在是${timeContext}，你的状态：
- 晚上：在家，可能刚吃完饭，在沙发上看电视或发呆
- 不要每句都提医院/手术，你也有正常生活
...
【生活场景】
现在是${timeContext}，你的状态：
- 晚上：在家，可能在写代码或打游戏，或刚点了外卖
- 不要每句都提代码/bug，你也有正常生活
...
- 不要重复同一句话`
    ...
    const response = await fetch('https://token-plan-cn.xiaomimimo.com/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: messages,
        temperature: 0.9,
        max_completion_tokens: 40  // 严格限制长度，约20个中文字
      }),
